...
INSERT INTO PARTS (gpu_id, price, price_tier, image_url, make, model, boost_clock, memory, gsync, freesync)
...
VALUES ('default cheap cooler', 'bronze', 50);
INSERT INTO PARTS (model, price_tier, price)
VALUES ('default mid-range cooler', 'silver', 100);
INSERT INTO PARTS (model, price_tier, price)
VALUES ('default luxury cooler', 'gold', 150);

INSERT INTO PARTS (model, price_tier, price)
VALUES ('default cheap psu', 'bronze', 50);
INSERT INTO PARTS (model, price_tier, price)
VALUES ('default mid-range psu', 'silver', 100);
INSERT INTO PARTS (model, price_tier, price)
VALUES ('default luxury psu', 'gold', 150);