...
INSERT INTO PARTS
    (ram_id, make, model, capacity, price, price_tier, transfer_rate)
VALUES
    (1, 'Corsair', 'Vengeance', '4GB', 20, 'bronze', 2666);
INSERT INTO PARTS
    (ram_id, make, model, capacity, price, price_tier, transfer_rate)
VALUES
    (2, 'Kingston', 'HyperX Fury', '8GB', 40, 'bronze', 2666);
INSERT INTO PARTS
    (ram_id, make, model, capacity, price, price_tier, transfer_rate)
VALUES
    (3, 'Kingston', 'HyperX Predator', '16GB', 60, 'silver', 2666);
INSERT INTO PARTS
    (ram_id, make, model, capacity, price, price_tier, transfer_rate)
VALUES
    (4, 'G.', 'Skill Trident', '32GB', 120, 'gold', 2666);

INSERT INTO PARTS
    (ssd_id, make, capacity, price)
VALUES
    (1, 'PNY', '240 GB', 30);
INSERT INTO PARTS
    (ssd_id, make, capacity, price)
...
VALUES
    ('Cooler Master Hyper 212 Evo', 'bronze', 35);
INSERT INTO PARTS
    (model, price_tier, price)
VALUES
...
INSERT INTO PARTS
    (model, price_tier, price)
VALUES
    ('ASUS Prime X570-P', 'silver', 170);
INSERT INTO PARTS
    (model, price_tier, price)
VALUES
    ('MSI MPG X570', 'gold', 200);

INSERT INTO PARTS
    (model, price_tier, voltage, price)
VALUES
    ('EVGA SuperNova G3', 'bronze', 550, 100);
INSERT INTO PARTS
    (model, price_tier, voltage, price)
VALUES
    ('EVGA SuperNova G2', 'silver', 650, 130);
INSERT INTO PARTS
    (model, price_tier, voltage, price)
VALUES
    ('EVGA SuperNova G2', 'gold', 650, 130);
