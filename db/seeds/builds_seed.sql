...
VALUES
    ('bronze', 'gaming', 'gato', 'built for casual gaming', 1, 1, 2, 2);
INSERT INTO BUILDS
    (price_tier, build_type, build_name, build_description, cpu_id, gpu_id, ram_id, ssd_id)
VALUES
    ('silver', 'gaming', 'tigre', 'a capable choice for AAA games and semi-competitive play', 2, 2, 3, 3);
INSERT INTO BUILDS
    (price_tier, build_type, build_name, build_description, cpu_id, gpu_id, ram_id, ssd_id)
VALUES
...
INSERT INTO BUILDS
    (price_tier, build_type, build_name, build_description, cpu_id, gpu_id, ram_id, ssd_id)
VALUES
    ('silver', 'streaming', 'delfin', 'our mid-level approach for semi-professional streaming', 5, 5, 3, 3);

INSERT INTO BUILDS
    (price_tier, build_type, build_name, build_description, cpu_id, gpu_id, ram_id, ssd_id)
VALUES
    ('gold', 'streaming', 'tiburon', 'a top of the line rig for experienced and demanding professional streamers', 3, 3, 4, 4);
...
INSERT INTO BUILDS
    (price_tier, build_type, build_name, build_description, cpu_id, gpu_id, ram_id, ssd_id)
VALUES
    ('silver', 'creator', 'jirafa', 'well-balanced specs that should be enough for the majority of creators', 3, 3, 3);
