        ...
        <div className="home">
            ...
            <div className="categories">
                ...
                <div className="streamersHomeButton">
                    <div className="nicheImage">
                        <Link to="/builds/streaming"><img className='animalToken' width="100" height="100" src="https://imgur.com/86Y951p.png " alt={"aquatic"}></img></Link>
                    </div>
                        <h1>AQUATICA</h1>
                        <h2>Streaming PCs</h2>
                ...
                <div className="creatorsHomeButton">
                    <div className="nicheImage">
                        <Link to="/builds/creators"><img className='animalToken' src="https://imgur.com/pTUWENT.png " alt={"birds"}></img></Link>
                    </div>
                        <h1>ETEREO</h1>
                        <h2>Creator PCs</h2>
                        <h3>Nimble builds suited to any creative task</h3>
